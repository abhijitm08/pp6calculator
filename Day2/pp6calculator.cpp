...
#include "PP6Math.hpp"
//#include "PP6Math.cpp"
#include "PP6Math.hpp"//included twice, see part 2 of day2 lecture
...
int main() 
{
	...
	{	
		...
		std::cout << "	If you want to swap two numbers, type 8" << std::endl;
		std::cout << "	If you want to use Bubble sort to sort your array of number, type 9" << std::endl;
